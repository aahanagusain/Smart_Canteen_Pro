...
export const CartProvider = ({ children }) => {
  ...
  const reorder = (restaurantId, restaurantName, orderItems) => {
  ...
  return (
    <CartContext.Provider value={{ items, addToCart, inc, dec, remove, clear, reorder, totalItems, totalPrice }}>
      {children}
